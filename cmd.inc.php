	...
	case "privmsg":
		...
		} else 
		{
			switch(strtolower($command)) { // channel
				case $trigger."kaffee":
					if($exp[4]){
						privmsg($exp[2],"\001ACTION gibt ".$exp[4]." einen heißen Kaffee\001");
					}else{
						privmsg($exp[2],"\001ACTION gibt ".$nick." einen heißen Kaffee");
					}
					break;
				case $trigger."kakao":
					if($exp[4]){
						privmsg($exp[2],"\001ACTION gibt ".$exp[4]." einen heißen Kakao mit Sahne\001");
					}else{
						privmsg($exp[2],"\001ACTION gibt ".$nick." einen heißen Kakao mit Sahne\001");
					}
					break;
				case $trigger."stats":
					create_stats($exp[2]);
